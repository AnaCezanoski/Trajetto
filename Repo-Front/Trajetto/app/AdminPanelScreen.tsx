...
export default function AdminPanelScreen() {
  ...
  const load = async () => {
    try {
      const [ov, co, pr, ag] = await Promise.all([
  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <View style={styles.quickActions}>
        ...
        <TouchableOpacity
          style={[styles.quickCard, { backgroundColor: '#7C3AED' }]}
          onPress={() => router.push('/UserListScreen')}
          activeOpacity={0.85}
        >
        ...
        <TouchableOpacity
          style={[styles.quickCard, { backgroundColor: '#16A34A' }]}
          onPress={() => router.push('/UserListScreen')}
          activeOpacity={0.85}
        >
          {/*<Text style={styles.quickIcon}>✅</Text>*/}
      ...
      {loading ? (
        ...
        >
          ...
          {/* ─── Acesso rápido à lista de usuários ─── */}
          <TouchableOpacity
