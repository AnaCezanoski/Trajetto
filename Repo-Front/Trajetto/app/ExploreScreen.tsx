  ...
  function renderEmpty() {
      ...
      return (
        <View style={styles.emptyContainer}>
          ...
          <Text style={styles.emptyText}>
            Type the name of a city to find tourist attractions.
          </Text>
        </View>
      );
    }
    return (
      <View style={styles.emptyContainer}>
        ...
        <Text style={styles.emptyText}>
         Try increasing the search radius or searching for another city.
        </Text>
      </View>
    );
  }
      ...
      >
        ...
        {searched && !loading && (
          <Text style={styles.resultsLabel}>
            {spots.length} points found in{' '}
            <Text style={styles.resultsCity}>{cityName}</Text>
          </Text>
        )}
