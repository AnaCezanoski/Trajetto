...
const styles = StyleSheet.create({
  ...
  link: { textAlign: 'center', marginTop: 16, color: '#023665' },passwordWrapper: {
   flexDirection: 'row',alignItems: 'center',borderWidth: 1, borderColor: '#ddd', borderRadius: 8,
   marginBottom: 12, paddingHorizontal: 12,},passwordInput: {flex: 1,paddingVertical: 12,fontSize: 16,},
