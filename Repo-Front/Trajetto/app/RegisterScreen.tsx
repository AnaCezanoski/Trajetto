...
const styles = StyleSheet.create({
  ...
  buttonText: { color: '#fff', fontWeight: 'bold', fontSize: 16 }, inputText: {fontSize: 16, color: '#000', paddingVertical: 2,},
  ...
  flex: 1, marginBottom: 0, }, dropdownWrapper: {position: 'relative',zIndex: 10,marginBottom: 12,},
   ...
   dropdownItemText: {fontSize: 16,color: '#000',},passwordWrapper: {flexDirection: 'row',alignItems: 'center',
       borderWidth: 1,borderColor: '#ddd',borderRadius: 8,marginBottom: 12,paddingHorizontal: 12,},
     passwordInput: {flex: 1,paddingVertical: 12,fontSize: 16,},eyeBtn: {paddingLeft: 8,justifyContent: 'center',alignItems: 'center',},
});